...
?><article <?php post_class( array(
			...
			the_title( '<h1 class="entry-title content-title" itemprop="name">', '</h1>' );
				...
				$prev_post_link = get_previous_post_link(
					...
					'<span class="content-nav-link-wrap">' . 
						...
						'<span class="content-nav-link-label">' . __( 'Older', 'helium' ) . '</span>' . 
					'</span>'
				);
				...
				$next_post_link = get_next_post_link(
					'<li class="content-nav-link">%link</li>', 
					'<span class="content-nav-link-wrap">' . 
						'<span class="content-nav-link-label">' . __( 'Newer', 'helium' ) . '</span>' . 
				...
				<ul><?php
						...
						echo '<li class="content-nav-link disabled">';
							echo '<span>';
								echo '<span class="content-nav-link-wrap">';
									...
									echo '<span class="content-nav-link-label">' . __( 'Older', 'helium' ) . '</span>';
								echo '</span>';
							echo '</span>';
						echo '</li>';
					endif;
					...
					if( $next_post_link ):
						...
						echo '<li class="content-nav-link disabled">';
							echo '<span>';
								echo '<span class="content-nav-link-wrap">';
									echo '<span class="content-nav-link-label">' . __( 'Newer', 'helium' ) . '</span>';
	...
	<div class="content-wrap">
				...
				<div class="container">
					...
					<div class="row">
						...
						?><div class="<?php echo esc_attr( $sidebar_class ); ?>">
							...
							?><li>
								<h5 class="item-detail-label"><?php echo esc_html( $detail['label'] ); ?></h5>
								<span class="item-detail-value"><?php echo $value ?></span>
							</li>
							<?php
								endif;
							endforeach;
		...
		<?php if( helium_get_option( 'portfolio_show_related_items' ) ):
			get_template_part( 'template-parts/portfolio/related' );
		endif; ?>
