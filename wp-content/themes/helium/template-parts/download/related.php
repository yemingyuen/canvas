<?php
$related_items_count = helium_get_option( 'edd_related_items_count' );
	...
	<div class="content-wrap-inner three-quarters-vertical-padding">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<h4 class="bordered no-margin-top"><?php _e( 'Related Downloads', 'helium' ); ?></h4>
				</div>
			...
			<div class="related-items row">
				...
				$use_lightbox = ( 'lightbox' === helium_get_option( 'edd_related_items_behavior' ) );
				...
				?><article <?php post_class( array( 'related-item', 'col-md-' . $col_width ) ); ?>>
					...
					?><p class="related-item-meta"><?php echo edd_price( get_the_ID() ); ?></p>
