			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<time class="post-date updated" datetime="<?php echo esc_attr( get_the_date( 'c' ) ); ?>" itemprop="datePublished"><?php 
						echo esc_html( get_the_date( helium_get_option( 'blog_date_format' ) ) );
					?></time>
					...
					<?php
						...
						$hidden_post_meta = helium_get_option( 'hidden_post_meta' );
					...
					?><div class="post-meta">
						...
						<ul class="post-meta-list inline-list"><?php
							...
							?><li><i class="fa fa-paperclip"></i> <?php _e( 'Sticky', 'helium' ) ?></li>
							<?php endif;
							...
							?><li><i class="slicon slicon-link"></i> <a href="<?php the_permalink(); ?>" itemprop="url"><?php _e( 'Permalink', 'hanabi' ) ?></a></li>
							<?php endif;
