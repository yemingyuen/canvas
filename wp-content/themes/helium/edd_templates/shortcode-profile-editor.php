...
if ( is_user_logged_in() ):
	...
	if ( edd_is_cart_saved() ): ?>
		...
		<div class="alert alert-success edd_success">
			<strong><?php _e( 'Saved cart', 'helium'); ?>:</strong> <?php printf( __( 'You have a saved cart, <a href="%s">click here</a> to restore it.', 'helium' ), $restore_url ); ?>
		</div>
	<?php endif; ?>

	<?php if ( isset( $_GET['updated'] ) && $_GET['updated'] == true && ! edd_get_errors() ): ?>
		<div class="alert alert-success edd_success">
			<strong><?php _e( 'Success', 'helium'); ?>:</strong> <?php _e( 'Your profile has been edited successfully.', 'helium' ); ?>
		</div>
	<?php endif; ?>
	...
	<form id="edd_profile_editor_form" class="edd_form" action="<?php echo esc_url( edd_get_current_page_url() ); ?>" method="post">
		...
		<fieldset>
			<span id="edd_profile_name_label"><legend><?php _e( 'Change your Name', 'helium' ); ?></legend></span>

			<div class="form-group">
				<label for="edd_first_name" class="control-label"><?php _e( 'First Name', 'helium' ); ?></label>
			...
			<div class="form-group">
				<label for="edd_last_name" class="control-label"><?php _e( 'Last Name', 'helium' ); ?></label>
				<input name="edd_last_name" id="edd_last_name" class="text edd-input form-control" type="text" value="<?php echo esc_attr( $last_name ); ?>" >
			</div>

			<div class="form-group">
				<label for="edd_display_name" class="control-label"><?php _e( 'Display Name', 'helium' ); ?></label>
			...
			<div class="form-group">
				<label for="edd_email" class="control-label"><?php _e( 'Email Address', 'helium' ); ?></label>
			...
			<span id="edd_profile_billing_address_label"><legend><?php _e( 'Change your Billing Address', 'helium' ); ?></legend></span>

			<div class="form-group">
				<label for="edd_address_line1" class="control-label"><?php _e( 'Line 1', 'helium' ); ?></label>
			...
			<div class="form-group">
				<label for="edd_address_line2" class="control-label"><?php _e( 'Line 2', 'helium' ); ?></label>
			...
			<div class="form-group">
				<label for="edd_address_city" class="control-label"><?php _e( 'City', 'helium' ); ?></label>
			...
			<div class="form-group">
				<label for="edd_address_zip" class="control-label"><?php _e( 'Zip / Postal Code', 'helium' ); ?></label>
			...
			<div class="form-group">
				<label for="edd_address_country" class="control-label"><?php _e( 'Country', 'helium' ); ?></label>
			...
			<div class="form-group">
				<label for="edd_address_state" class="control-label"><?php _e( 'State / Province', 'helium' ); ?></label>
			...
			<span id="edd_profile_password_label"><legend><?php _e( 'Change your Password', 'helium' ); ?></legend></span>

			<div class="form-group">
				<label for="edd_user_pass" class="control-label"><?php _e( 'New Password', 'helium' ); ?></label>
				<input name="edd_new_user_pass1" id="edd_new_user_pass1" class="password edd-input form-control" type="password">
			</div>

			<div class="form-group">
				<label for="edd_user_pass" class="control-label"><?php _e( 'Re-enter Password', 'helium' ); ?></label>
				<input name="edd_new_user_pass2" id="edd_new_user_pass2" class="password edd-input form-control" type="password">
			</div>

			<p class="edd_password_change_notice help-block"><?php _e( 'Please note after changing your password, you must log back in.', 'helium' ); ?></p>
			...
			<input name="edd_profile_editor_submit" id="edd_profile_editor_submit" type="submit" class="edd_submit btn btn-primary" value="<?php _e( 'Save Changes', 'helium' ); ?>">
	...
	echo __( 'You need to login to edit your profile.', 'helium' );
	echo edd_login_form();
endif;
