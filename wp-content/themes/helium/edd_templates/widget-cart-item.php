<li class="edd-cart-item" data-cart-quantity="<?php echo esc_attr( edd_get_cart_quantity() ); ?>">
	...
	<a href="{remove_url}" data-cart-item="{cart_item_id}" data-download-id="{item_id}" data-action="edd_remove_from_cart" class="edd-remove-from-cart"><?php _e( 'remove', 'helium' ); ?></a>
</li>
