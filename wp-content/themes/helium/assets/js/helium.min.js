...
(function(d){d.fn.imagesLoaded=function(k){function e(){k.call(b,c)}function f(a){a=a.target;"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="!==a.src&&-1===d.inArray(a,g)&&(g.push(a),0>=--h&&(setTimeout(e),c.unbind(".imagesLoaded",f)))}var b=this,c=b.find("img").add(b.filter("img")),h=c.length,g=[];h||e();c.bind("load.imagesLoaded error.imagesLoaded",f).each(function(){var a=this.src;this.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";this.src=a});return b}})(jQuery);
...
(function(a,e,p){var f=a(p),l=a(e),m=a(p.body),d=e.Helium=e.Helium||{};a.extend(d,{isMobile:_helium.isMobile,mql:e.matchMedia&&e.matchMedia("(min-width: 992px)"),windowHeight:l.height(),init:function(){d.isMobile||a("html").addClass("desktop");d.setupListeners();a(d.ready)},ready:function(){d.applyPatches();(function(){if(_helium.ajaxNavigation){var b=null,c=History.getRootUrl(),k=null,h=null,g=a("<span></span>").text(_helium.ajaxNavigation.loadingText),q=a(".content-area-wrap"),t=function(){var b=
a(this).hasClass("preloading");a(this).html(g).addClass("preloading");if(!a.support.transition||d.isMobile||b)r.apply(this);else a(this).off(a.support.transition.end).one(a.support.transition.end,r)},r=function(){if(b instanceof TimelineLite)b.restart();else{var a=new SplitText(g,{type:"chars,words"});b=new TimelineLite({onComplete:function(){b.restart()}});b.staggerTo(a.chars.reverse(),.4,{x:10,autoAlpha:0,ease:Quint.easeOut},.1).staggerTo(a.chars.reverse(),.4,{x:0,autoAlpha:1,ease:Quint.easeOut},
.1)}},n=function(){k=a(".content-area");h=a(".content-area .content-title");var b=k.hasClass("unloading");k.addClass("unloading");if(!a.support.transition||d.isMobile||b)t.apply(h.get(0));else h.off(a.support.transition.end).one(a.support.transition.end,t)},f=function(b){var c=function(){h=k=null;g.remove();b.length&&(d.teardown(this),d.setup(this.html(b)),this.find(".content-area").removeClass("beforeload"))};h&&h.removeClass("preloading");if(a.support.transition&&!d.isMobile&&h)h.off(a.support.transition.end).one(a.support.transition.end,
a.proxy(c,q));else c.apply(q)};d.AjaxNavigator.init({linkSelector:"a.ajaxify, .header .brand a, .main-nav .menu a, .portfolio a.portfolio-info-link, .pages-nav a, .post-tags a, .content-nav a, .post-title a, .post-meta a, .post-media a, .post-body a.more-link, .related-item-media a:not(.mfp-image), .related-item-title a, .related-item-meta a, .edd-download-title a, a.edd-download-view-details, .grid-list a.grid-list-image-link.grid-list-page, .featured-portfolio-slider .entry-link, .search-entry-post-type a, .search-entry-title a",
excludeUrls:_helium.ajaxNavigation.excludeUrls,bodyClassReplacer:function(a){m.hasClass("nav-open")&&(a=[a,"nav-open"].join(" "));m[0].className=a},stateChange:function(a,b){if(0==l.scrollTop()||!_helium.ajaxNavigation.scrollTop||d.isMobile)d.isMobile&&l.scrollTop(0),n();else return TweenLite.to(e,.5,{scrollTo:0,autoKill:!1,onComplete:function(){n();b()}}),!1},done:function(h,g){var d,n,k=a(h);n=k.find(".content-area");k=k.find(".main-nav .menu .menu-item");b instanceof TimelineLite&&b.kill();k.each(function(){this.id&&
(d=p.getElementById(this.id))&&(a(d).hasClass("sub-menu-open")&&a(this).addClass("sub-menu-open"),d.className=this.className)});n.addClass("beforeload");n=a("<div></div>").append(n).html();f(n);"undefined"!==typeof e._gaq&&e._gaq.push(["_trackPageview",g.replace(c,"")])}})}})();d.setup(this,!0);d.onResize()},onResize:function(){d.windowHeight=l.height();a(".site-wrap").removeClass("header-open");d.adjustFullscreenContent(m);a(".main-nav").find("ul").css("display","").end().find(".sub-menu-open").removeClass("sub-menu-open")},
onMqlChange:function(b){b.matches&&a(function(){a(".header-content-bottom").css("display","")});f.off(".hoverIntent").off("click.subnav-close");b.matches&&(a.fn.hoverIntent&&f.hoverIntent({over:function(){a(this).children("ul.sub-menu").stop().slideDown().closest(".menu-item").addClass("sub-menu-open")},out:a.noop,selector:".main-nav .menu-item-has-children"}),f.on("click.subnav-close",".menu-item.sub-menu-open .subnav-close",function(b){a(this).closest(".menu-item").removeClass("sub-menu-open");
a(this).siblings("ul.sub-menu").stop(!0,!0).slideUp(function(){a(this).find("ul.sub-menu").hide();a(this).find(".sub-menu-open").addBack().removeClass("sub-menu-open")})}));f.off(".helium.nav");a(function(){a(".site-wrap").off(a.support.transition.end+".helium.nav")});b.matches||(a(function(){a(".header-content-bottom").hide();a(".site-wrap").on(a.support.transition.end+".helium.nav",function(b){this!=b.target||a(this).hasClass("header-open")||a(".header-content-bottom").hide()})}),f.on("click.helium.nav.toggle",
".header-toggle",function(b){a(".site-wrap").hasClass("header-open")||a(".header-content-bottom").show();a(".site-wrap").toggleClass("header-open");b.preventDefault()}),f.on("click.helium.nav",".main-nav .menu-item a",function(){a(".site-wrap").removeClass("header-open")}))},setupListeners:function(){l.on("resize.helium orientationchange.helium",d.onResize);m.on("edd_cart_item_added",function(b,c){var d=a("<div></div>").append(c.cart_item).find(".edd-cart-item").data("cart-quantity");a(".header-links .edd-shopping-cart .header-links-tooltip").text(d)});
f.on("click.helium.btt",".back-to-top > a",function(a){d.isMobile?l.scrollTop(0):TweenLite.to(e,.5,{scrollTo:0,autoKill:!1});a.preventDefault()});(function(){var b=function(){a(".search-wrap .search-form").length&&a(".search-wrap .search-form")[0].reset();m.addClass("search-open");f.on("keyup.helium.search",function(a){27==a.keyCode&&c()})},c=function(){m.removeClass("search-open");f.off("keyup.helium.search")};f.on("click.helium.search",".header-links .ajax-search-link a",function(a){b();a.preventDefault()});
if(_helium.ajaxNavigation)f.on("submit",".search-open .search-wrap .search-form",function(b){var h=_helium.homeUrl+"?s="+a(".form-control",this).val();c();History&&History.pushState(null,null,h);b.preventDefault()})})();if(d.mql)d.mql.addListener(d.onMqlChange),d.onMqlChange(d.mql);else d.onMqlChange({matches:!0})},adjustFullscreenContent:function(b){a(".content-area.fullscreen .content-wrap",b).each(function(){a(this).css({height:l.height()-(d.mql.matches?0:a(this).offset().top)})})},setup:function(b,
c){b=a(b);b.length||(b=m);d.adjustFullscreenContent(b);a.fn.royalSlider&&a(".royalSlider",b).each(function(){a(this).royalSlider(a.extend(!0,{},a(this).data("rs-settings"),{slidesSpacing:0,imageScalePadding:0,keyboardNavEnabled:!0,addActiveClass:!0}))});a.fn.isotope&&a(".gallery").each(function(){var b=a(this);b.imagesLoaded(function(){b.isotope()})});a.fn.justifiedGrids&&a(".justified-grids",b).justifiedGrids();a.fn.heliumGridList&&a(".grid-list",b).heliumGridList({afterAppend:function(b,g){a(this).is(".edd-download-grid")&&
(a(".edd-no-js",g).hide(),a("a.edd-add-to-cart",g).addClass("edd-has-js"))}});a.fn.cycle&&a(".cycle-slider",b).cycle();a.fn.magnificPopup&&a.each({".gallery":".gallery-item a",".grid-list-wrap":".grid:visible .grid-list-image-link.grid-list-mfp",".related-items":".related-item-media a.mfp-image","a.mfp-image":!1},function(h,g){a(h,b).each(function(){a(this).magnificPopup({delegate:g,type:"image",gallery:g?{enabled:!0,navigateByImgClick:!0}:!1})})});a.fn.magnificPopup&&(d.TeamTemplate=d.TeamTemplate||
new Hogan.Template(function(a,b,c){this.b(c=c||"");this.s(this.f("photo",a,b,1),a,b,0,10,82,"{{ }}")&&(this.rs(a,b,function(a,b,c){c.b('<figure class="team-photo"><img src="');c.b(c.v(c.f("photo",a,b,0)));c.b('" alt="');c.b(c.v(c.f("name",a,b,0)));c.b('"></figure>')}),a.pop());this.b('<div class="team-info"><div class="team-header"><h3 class="team-name">');this.b(this.v(this.f("name",a,b,0)));this.b("</h3>");this.s(this.f("role",a,b,1),a,b,0,184,217,"{{ }}")&&(this.rs(a,b,function(a,b,c){c.b('<p class="team-role">');
c.b(c.v(c.f("role",a,b,0)));c.b("</p>")}),a.pop());this.b("</div>");this.s(this.f("content",a,b,1),a,b,0,244,291,"{{ }}")&&(this.rs(a,b,function(a,b,c){c.b('<div class="team-description">');c.b(c.v(c.f("content",a,b,0)));c.b("</div>")}),a.pop());this.s(this.f("has_social",a,b,1),a,b,0,318,453,"{{ }}")&&(this.rs(a,b,function(a,b,c){c.b('<div class="team-social"><ul>');c.s(c.f("social_profiles",a,b,1),a,b,0,367,422,"{{ }}")&&(c.rs(a,b,function(a,b,c){c.b('<li><a href="');c.b(c.v(c.f("url",a,b,0)));
c.b('"><i class="');c.b(c.v(c.f("icon",a,b,0)));c.b('"></i></a></li>')}),a.pop());c.b("</ul></div>")}),a.pop());this.b("</div>");return this.fl()}),a(".team .team-photo a",b).magnificPopup({gallery:{enabled:!0},inline:{markup:'<div class="team-popup"></div>'},callbacks:{elementParse:function(b){if(b.el){var c=a(b.el).closest(".team").data("team-data");c&&(b=a.extend(!0,b,{data:c}),delete b.src,delete b.el)}return b},markupParse:function(a,b,c){a.empty().html(d.TeamTemplate.render(b))}}}));a.fn.fitVids&&
a(".featured-content, .post-media",b).fitVids();a.fn.youxiGoogleMaps&&a(".google-maps",b).youxiGoogleMaps();"undefined"!==typeof addthis&&addthis.toolbox(".addthis_toolbox");if(!c&&_helium.edd&&(_helium.edd.ajaxDisabled||(a(".edd-no-js",b).hide(),a("a.edd-add-to-cart",b).addClass("edd-has-js")),e.edd_scripts)){var k=_helium.edd.checkoutPage==e.location.href;e.edd_scripts.redirect_to_checkout=_helium.edd.straightToCheckout||k?"1":"0"}c||a.fn.wpcf7InitForm&&a("div.wpcf7 > form",b).wpcf7InitForm();!c&&
a.fn.mediaelementplayer&&function(){var c={};"undefined"!==typeof _wpmejsSettings&&(c=_wpmejsSettings);c.success=function(a){var b,c;"flash"===a.pluginType&&(b=a.attributes.autoplay&&"false"!==a.attributes.autoplay,c=a.attributes.loop&&"false"!==a.attributes.loop,b&&a.addEventListener("canplay",function(){a.play()},!1),c&&a.addEventListener("ended",function(){a.play()},!1))};a(".wp-audio-shortcode, .wp-video-shortcode",b).mediaelementplayer(c)}()},teardown:function(b){b=a(b);b.length||(b=m);a.fn.royalSlider&&
a(".royalSlider",b).each(function(){var b=a(this).data("royalSlider");b&&b.destroy()});a.fn.justifiedGrids&&a(".justified-grids",b).justifiedGrids("destroy");a.fn.cycle&&a(".cycle-slider",b).cycle("destroy");a.fn.isotope&&a(".gallery").isotope("destroy");a(".grid-list",b).each(function(){var b=a.data(this,"helium.gridlist._inst");b instanceof d.GridList&&b.destroy()});a.magnificPopup&&(a.magnificPopup.instance.close(),a.magnificPopup.instance.items=null,a.magnificPopup.instance.ev=null,a.magnificPopup.instance.st=
null,a.magnificPopup.instance.contentContainer=null);a.fn.youxiGoogleMaps&&a(".google-maps",b).youxiGoogleMaps("destroy");a.fn.ajaxFormUnbind&&a("div.wpcf7 > form",b).ajaxFormUnbind().unbind(".form-plugin");a.fn.mediaelementplayer&&a(".wp-audio-shortcode, .wp-video-shortcode",b).mediaelementplayer(!1)},windowLoad:function(){},applyPatches:function(){(function(b){a.fn.mediaelementplayer=function(c){!1!==c&&(this.filter(".wp-video-shortcode").css({width:"100%",height:"100%"}),c=a.extend(c,{audioHeight:36}));
return b.apply(this,[c])}})(a.fn.mediaelementplayer)}});d.AjaxNavigator={defaults:{stateChange:a.noop,done:a.noop,fail:a.noop,always:a.noop,titleReplacer:null,bodyClassReplacer:null,stateChangeContext:null,doneContext:null,failContext:null,alwaysContext:null,titleReplacerContext:null,bodyClassReplacerContext:null,ajaxParams:{},linkSelector:"a:not(.no-ajaxify)",excludeUrls:[]},_hash:function(){return"tag-"+Math.random().toString(36).substr(2,9)},init:function(b){e.History&&e.History.enabled&&(this.options=
a.extend(!0,{},this.defaults,b),f.on("click.ajaxnavigator",this.options.linkSelector,a.proxy(this.onClick,this)),l.on("statechange.ajaxnavigator",a.proxy(this.onStateChange,this)))},onClick:function(b){var c=b.currentTarget,d=History.getRootUrl();a.map(this.options.excludeUrls||[],function(a){if(c.href.substring(0,a.length)===a)return a}).length||c.href.substring(0,d.length)!==d&&-1<c.href.indexOf(":")||1<b.which||b.metaKey||b.ctrlKey||b.shiftKey||b.altKey||location.protocol!==c.protocol||location.hostname!==
c.hostname||c.hash&&c.href.replace(c.hash,"")===location.href.replace(location.hash,"")||c.href===location.href+"#"||b.isDefaultPrevented()||(History.pushState(null,null,c.href),b.preventDefault())},onStateChange:function(b){var c=History.getState();b=a.proxy(function(){this._doRequest.apply(this,[c.url,this.options.ajaxParams])},this);a.isFunction(this.options.stateChange)&&!1===this.options.stateChange.apply(this.options.stateChangeContext||this,[c.url,b])||b()},_documentHtml:function(b,c){var d=
String(b).replace(/<(html|head|title|body)([\s\>])/gi,"<div data-"+c+'="$1"$2').replace(/<\/(html|head|title|body)\>/gi,"</div>");return a.trim(d)},_doRequest:function(b,c){a.ajax(b,a.extend(c,{context:this,dataType:"html",type:"GET"})).done(function(c){var d=a(p.createElement("div")).append(a.parseHTML(c,!0)),g=d.find("title"),e=d.find("body");d.find("script[src]");var f=this._hash();c=a(this._documentHtml(c,f));g.length||(g=c.find("[data-"+f+'="title"]'));e.length||(e=c.find("[data-"+f+'="body"]'));
g.length&&(a.isFunction(this.options.titleReplacer)?this.options.titleReplacer.apply(this.options.titleReplacerContext,[g.text()]):p.title=g.text());e.length&&(a.isFunction(this.options.bodyClassReplacer)?this.options.bodyClassReplacer.apply(this.options.bodyClassReplacerContext,[e[0].className]):p.body.className=e[0].className);a.isFunction(this.options.done)&&this.options.done.apply(this.options.doneContext||this,[a("<div></div>").append(d).html(),b])}).fail(a.proxy(this.options.fail,this.options.failContext)).always(a.proxy(this.options.always,
this.options.alwaysContext))}};d.init();l.load(d.windowLoad)})(jQuery,window,document);

(function(b,g,k){b(k);var l=b(g);b(k.body);var m=b({});b.ajaxQueue=function(a){function c(c){h=b.ajax(a);h.done(e.resolve).fail(e.reject).then(c,c)}var h,e=b.Deferred(),d=e.promise();m.queue(c);d.abort=function(f){if(h)return h.abort(f);var g=m.queue(),k=b.inArray(c,g);-1<k&&g.splice(k,1);e.rejectWith(a.context||a,[d,f,""]);return d};return d};var d=g.Helium=g.Helium||{};d.GridList=function(a,c){this.element=b(a);return this._init(c)};d.GridList.instances=0;d.GridList.prototype={_mql:g.matchMedia&&
g.matchMedia("(min-width: 992px)"),_defaults:{itemSelector:".grid",itemsWrapperSelector:".grid-list-wrap",itemsFilterSelector:".grid-list-filter",paginationSelector:".grid-list-nav",layout:"masonry",pagination:!1,ajaxLoadingText:"Loading",ajaxButtonText:"Load More",ajaxButtonCompleteText:"No More Items",beforeAppend:b.noop,afterAppend:b.noop},_init:function(a){this.options=b.extend(!0,{},this._defaults,a,this._extractOptions(this.element.data()));this.eventNamespace=".helium.gridlist._inst"+ ++d.GridList.instances;
this.itemsFilter=this.element.find(this.options.itemsFilterSelector);this.itemsWrapper=this.element.find(this.options.itemsWrapperSelector);this.items=this.itemsWrapper.find(this.options.itemSelector);this.pagination=this.element.find(this.options.paginationSelector);this._createAdapter();this._createAjaxNav();this._bindHandlers()},_afterFilter:function(){"infinite"===this.options.pagination&&b.waypoints&&b.waypoints("refresh")},_bindHandlers:function(){var a=this;this._bindImageLoad();this.itemsFilter.on("click"+
this.eventNamespace,".filter[data-filter]",function(c){a.itemsFilter.find(".filter.active").removeClass("active");b(this).addClass("active");a.filter(b(this).data("filter"));(a._mql&&!a._mql.matches||!a._mql&&992>l.width())&&a.itemsFilter.find(".filter-items").slideUp();c.preventDefault()});this._mql?(this._mqlListenerProxy=b.proxy(this._mqlListener,this),this._mql.addListener(this._mqlListenerProxy),this._mqlListener(this._mql)):this._mqlListener({matches:992<=l.width()});if(this.ajaxPagerLink&&
this.ajaxPagerLink.length)if("infinite"===this.options.pagination)this._initializeInfinite(void 0),this.ajaxPagerLink.on("click"+this.eventNamespace,function(a){a.preventDefault()});else this.ajaxPagerLink.on("click"+this.eventNamespace,function(b){a._query(this.href,"ajax");b.preventDefault()})},_bindImageLoad:function(a){var c=this;a=a?b(a).filter(this.options.itemSelector):this.items;a.each(function(){var a=b(this).find("img");if(a.length)if(a[0].complete)a.closest(c.options.itemSelector).addClass("loaded");
else a.one("load"+c.eventNamespace,function(){a.closest(c.options.itemSelector).addClass("loaded")});else b(this).addClass("loaded")})},_createAdapter:function(){var a=this.options.layout,c={},a=a.charAt(0).toUpperCase()+a.substr(1);d.GridList.Adapter.hasOwnProperty(a)&&(c=b.extend(c,{selector:this.options.itemSelector,afterAppend:this._updateAjaxPager,afterAppendScope:this,afterFilter:this._afterFilter,afterFilterScope:this}),this.adapter=new d.GridList.Adapter[a](this,c))},_createAjaxNav:function(){this.options.pagination.match(/^(ajax|infinite)$/)&&
(this.ajaxLinks=this.pagination.find(".content-nav .page-numbers:not(.current):not(.next):not(.prev):not(.dots)").map(function(){return this.href}).get(),this.ajaxLinks.length&&(this.ajaxPagerLink=b(k.createElement("a")).addClass("gridlist-ajax-link").text(this.options.ajaxButtonText).attr("href",this.ajaxLinks.shift()),this.pagination.find(".content-nav > ul").empty().append(b('<li class="content-nav-link"></li>').append(this.ajaxPagerLink))))},_extractOptions:function(a){var c={};b.each(a,function(a,
b){/^gridlist(.+)/.test(a)&&(a=a.match(/^gridlist(.+)/)[1],a=a.charAt(0).toLowerCase()+a.substr(1),c[a]=b)});return c},_initializeInfinite:function(){b.fn.waypoint&&this.ajaxPagerLink.length&&this.itemsWrapper.waypoint({offset:"bottom-in-view",triggerOnce:!0,handler:b.proxy(function(a){"down"===a&&this._query(this.ajaxPagerLink[0].href,"infinite")},this)})},_mqlListener:function(a){if(a.matches)this.itemsFilter.off("click"+this.eventNamespace,".filter-label").find(".filter-items").css("display","");
else this.itemsFilter.on("click"+this.eventNamespace,".filter-label",function(a){b(this).next(".filter-items").slideToggle();a.preventDefault()})},_updateAjaxPager:function(){if(this.ajaxLinks&&this.ajaxPagerLink){var a;(a=this.ajaxLinks.shift())?(this.ajaxPagerLink.attr("href",a).text(this.options.ajaxButtonText).closest(".content-nav-link").removeClass("disabled"),"infinite"===this.options.pagination&&this._initializeInfinite()):this.ajaxPagerLink.off(this.eventNamespace).text(this.options.ajaxButtonCompleteText).removeAttr("href").closest(".content-nav-link").addClass("disabled")}},
_query:function(a,c){a&&b.ajaxQueue({type:"GET",dataType:"html",url:a,context:this,beforeSend:function(){b(this.ajaxPagerLink).text(this.options.ajaxLoadingText).closest(".content-nav-link").addClass("disabled")}}).done(function(a){a=b(a).find(this.options.itemsWrapperSelector+" "+this.options.itemSelector);this.append(a)})},append:function(a){this.adapter&&(a=b(a).filter(this.options.itemSelector),b.isFunction(this.options.beforeAppend)&&this.options.beforeAppend.apply(this.element,[this,a]),this.items=
this.items.add(a),this.itemsWrapper.append(a),this._bindImageLoad(a),this.adapter._append(a),b.isFunction(this.options.afterAppend)&&this.options.afterAppend.apply(this.element,[this,a]))},filter:function(a){this.adapter&&this.adapter._filter(a)},destroy:function(){this.adapter&&(this.adapter._destroy(),this.adapter=null);this.itemsFilter&&this.itemsFilter.off(this.eventNamespace);this.ajaxPagerLink&&(this.ajaxPagerLink.off(this.eventNamespace),this.ajaxLinks=this.ajaxPagerLink=null);b.fn.waypoint&&
this.itemsWrapper.waypoint("destroy");this.pagination=this.items=this.itemsWrapper=this.itemsFilter=null;this._mql&&(b.isFunction(this._mqlListenerProxy)&&this._mql.removeListener(this._mqlListenerProxy),this._mql=this._mqlListenerProxy=null);b.removeData(this.element.get(0),"helium.gridlist._inst");this.element=null}};b.fn.heliumGridList=function(a){return this.each(function(){b.data(this,"helium.gridlist._inst")||b.data(this,"helium.gridlist._inst",new d.GridList(this,a))})};var f=d.GridList.Adapter=
function(a,b){this.manager=a;return this._init(b)};f.extend=function(a,c){var d=this,e;e=a&&a.hasOwnProperty("constructor")?a.constructor:function(){return d.apply(this,arguments)};b.extend(e,d,c);var f=function(){this.constructor=e};f.prototype=d.prototype;e.prototype=new f;a&&b.extend(e.prototype,a);e.__super__=d.prototype;return e};f.prototype={_defaults:{afterAppend:b.noop,afterAppendScope:g,afterFilter:b.noop,afterFilterScope:g},_init:function(a){this.options=b.extend(this._defaults,a)},_append:function(a){},
_filter:function(a){},_destroy:function(){this.manager=null}};d.GridList.Adapter.Classic=f.extend({_append:function(a){a&&a.length&&(a=this._currentFilter?a.hide().filter(this._currentFilter).show():a,this._visibleItems&&(this._visibleItems=this._visibleItems.add(a)),d.GridList.animationEnabled?(this._timeline||(this._timeline=new TimelineLite({paused:!0})),this._timeline.progress(1).kill().clear(!0).staggerFromTo(a,.2,{autoAlpha:0,y:-30},{autoAlpha:1,y:0,clearProps:"visibility,opacity,y"},.1,"+=0",
this.options.afterAppend,null,this.options.afterAppendScope).play()):b.isFunction(this.options.afterAppend)&&this.options.afterAppend.apply(this.options.afterAppendScope))},_filter:function(a){var c=this.manager.items,h,e;h=this._visibleItems||c;e=c;"string"==typeof a&&"*"!=a?(this._currentFilter=a,this._visibleItems=e=c.filter(a)):this._visibleItems=this._currentFilter=null;d.GridList.animationEnabled?(this._timeline||(this._timeline=new TimelineLite({paused:!0})),this._timeline.progress(1).kill().clear(!0).to(h,
.2,{autoAlpha:0,y:-30,onComplete:function(){h.css("display","none");e.css("display","")}}).staggerFromTo(e,.2,{opacity:0,y:-30},{autoAlpha:1,y:0,clearProps:"visibility,opacity,y"},.1,"+=0",this.options.afterFilter,null,this.options.afterFilterScope).play()):(h.css("display","none"),e.css("display",""),b.isFunction(this.options.afterFilter)&&this.options.afterFilter.apply(this.options.afterFilterScope))},_destroy:function(){this._visibleItems=this._currentFilter=null;d.GridList.animationEnabled&&this._timeline instanceof
TimelineLite&&(this._timeline.kill().clear(!0),this._timeline=null);f.prototype._destroy.apply(this,arguments)}});d.GridList.Adapter.Masonry=f.extend({_init:function(a){f.prototype._init.apply(this,arguments);var c=this.manager.itemsWrapper,d;c.isotope(b.extend(!0,{itemSelector:this.manager.options.itemSelector,isInitLayout:!1,masonry:{columnWidth:".grid-sizer"}},this.options));d=c.outerWidth();c.isotope("arrange");d!=c.outerWidth()&&c.isotope("arrange")},_append:function(a){a&&a.length&&(this.manager.itemsWrapper.isotope("once",
"layoutComplete",b.proxy(this.options.afterAppend,this.options.afterAppendScope)),this.manager.itemsWrapper.isotope("appended",a))},_filter:function(a){this.manager.itemsWrapper.isotope("once","layoutComplete",b.proxy(this.options.afterFilter,this.options.afterFilterScope));this.manager.itemsWrapper.isotope({filter:a})},_destroy:function(){this.manager.itemsWrapper.isotope("destroy");f.prototype._destroy.apply(this,arguments)}});d.GridList.Adapter.Justified=f.extend({_currentFilter:null,_init:function(a){f.prototype._init.apply(this,
arguments);this.manager.itemsWrapper.justifiedGrids(b.extend(!0,{selector:this.manager.options.itemSelector,margin:30,ratio:"img",assignHeight:!1},this.options))},_append:function(a){if(a&&a.length){var c=this.manager.itemsWrapper.justifiedGrids("getLastRow"),f=this._currentFilter?a.filter(this._currentFilter):a;a.hide();d.GridList.animationEnabled&&f.length&&c.length?TweenLite.to(c,.2,{autoAlpha:0,y:-30,onCompleteParams:[a],onCompleteScope:this,onComplete:function(a){a=this.manager.itemsWrapper.justifiedGrids("append",
a,!0);a.length&&(this._timeline||(this._timeline=new TimelineLite({paused:!0})),this._timeline.progress(1).kill().clear(!0).staggerFromTo(a,.2,{autoAlpha:0,y:-30},{autoAlpha:1,y:0,clearProps:"visibility,opacity,y"},.1,"+=0",this.options.afterAppend,null,this.options.afterAppendScope).play())}}):(this.manager.itemsWrapper.justifiedGrids("append",a,!0),b.isFunction(this.options.afterAppend)&&this.options.afterAppend.apply(this.options.afterAppendScope))}},_filter:function(a){if(!this._currentFilter||
this._currentFilter!=a){var c=this.manager.itemsWrapper,f,e;this._currentFilter=a;d.GridList.animationEnabled?(f=c.justifiedGrids("getItems",!0),e=c.justifiedGrids("getItems").filter(a),this._timeline||(this._timeline=new TimelineLite({paused:!0})),this._timeline.progress(1).kill().clear(!0).to(f,.2,{autoAlpha:0,y:-30,onComplete:function(){c.justifiedGrids("filter",a)}}).staggerFromTo(e,.2,{opacity:0,y:-30},{autoAlpha:1,y:0,clearProps:"visibility,opacity,y"},.1,"+=0",this.options.afterFilter,null,
this.options.afterFilterScope).play()):(this.manager.itemsWrapper.justifiedGrids("filter",a),b.isFunction(this.options.afterFilter)&&this.options.afterFilter.apply(this.options.afterFilterScope))}},_destroy:function(){this._currentFilter=null;this.manager.itemsWrapper.justifiedGrids("destroy");d.GridList.animationEnabled&&this._timeline instanceof TimelineLite&&(this._timeline.kill().clear(!0),this._timeline=null);f.prototype._destroy.apply(this,arguments)}});b(function(){d.GridList.animationEnabled=
"undefined"!==typeof TimelineLite&&!d.isMobile})})(jQuery,window,document);